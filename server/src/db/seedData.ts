import { Career, Skill, Assessment, Resource, StudentProfile, MentorIntervention, CurriculumGapInsight, UserAccount, NotificationItem, DoubtQuery, DoubtReply, PlacementCompanyDrive, PlacementApplication } from '../types/shared.js';
